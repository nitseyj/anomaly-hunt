...
export const TEMPLATES = [
  {
    ...
    scenarios: [
      ...
      { case_name: 'Weekly Sales Audit', scenario: 'Store revenue is tracked daily. A regional manager thinks one day doesn\u2019t match the usual pattern — find it.' },
    ],
  ...
  },
  {
    ...
    scenarios: [
      ...
      { case_name: 'Ticket Backlog Review', scenario: "Someone on the support team thinks volume spiked unusually on a specific day. Confirm it." },
    ],
    generate(rng, length = SERIES_LENGTH) {
  ...
  },
  {
    ...
    hasWeeklySeasonality: false,
    scenarios: [
      { case_name: 'Ad Campaign Audit', scenario: "Marketing wants to know if the campaign's return on ad spend held steady, or if a day underperformed." },
      { case_name: 'Paid Media Review', scenario: 'A media buyer flagged that ROAS "felt low" on one day this month. See if the data agrees.' },
    ],
    generate(rng, length = SERIES_LENGTH) {
  ...
  },
  {
    ...
    scenarios: [
      ...
      { case_name: 'Retention Health Check', scenario: 'A dip in retention was mentioned in standup. Find the day it actually happened, if it did.' },
    ],
    generate(rng, length = SERIES_LENGTH) {
