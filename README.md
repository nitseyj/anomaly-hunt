...
Both modes generate their own data at runtime — no Python step required
to play. Open the local dev URL Vite prints.
...
- [ ] Add a third mode: a segmentation/cohort challenge using the same data engine
